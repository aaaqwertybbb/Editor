...
class TrackedSyntaxList {
    ...
    getElementAt(index_abstract) {
        ...
        EDITOR_int_fields[INDEXOF_EDITOR_pooledTrackedSyntax_start] = this.data_literal[index_literal + this.start_offset];
        EDITOR_int_fields[INDEXOF_EDITOR_pooledTrackedSyntax_length] = this.data_literal[index_literal + this.length_offset];
    }
