...
class TrackedSyntaxList {
    ...
    getElementAt(index_abstract) {
        ...
        GLOB_int_fields[F_EDI_pooledTrackedSyntax_start] = this.data_literal[index_literal + this.start_offset];
        GLOB_int_fields[F_EDI_pooledTrackedSyntax_length] = this.data_literal[index_literal + this.length_offset];
    }
